                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control" name="cat_name" value="{{ $category->cat_name }}" placeholder="Nama Kategori" id="category_name" required>
                        ...
                        <div class="col-12">
                            <div class="form-group has-icon-left">
                                ...
                                <div class="position-relative">
                                    <textarea class="form-control" name="description" placeholder="(opsional)" id="description">{{ $category->description }}</textarea>
                                    <div class="form-control-icon">
